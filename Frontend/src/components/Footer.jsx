  ...
  return (
    <div>
      ...
      <footer className="footer footer-center p-10 text-base-content rounded dark:bg-slate-900 dark:text-white">
        ...
        <a href="/contact" className="link link-hover transition duration-300 hover:text-pink-500">
            Contact Us
          </a>
          <a href="/about" className="link link-hover transition duration-300 hover:text-pink-500">
            About Us
          </a>
        </nav>
        ...
        <aside className="mt-4 text-gray-500 dark:text-gray-400 text-sm">
          <p>Copyright © 2024 - All rights reserved by  Maurya Industries Ltd</p>
        </aside>
      </footer>
    </div>
  );
